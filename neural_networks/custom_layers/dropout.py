...
# inputs= torch.arange(35,requires_grad=True,dtype=float).reshape((1, 7, 5))
#
# print(inputs)
# net1 = nn.Dropout(0.5)
# net2 = SpatialDropout(0.5)
# print(net1(inputs).reshape((1,7,5)))
# print(net2(inputs).reshape((1,7,5)))